...
export default function Home() {
  const handleCopyLink = () => {
    navigator.clipboard.writeText("https://brpeças.pt");
    alert("Link copiado para a área de transferência!");
  };

  const currentUrl = encodeURIComponent("https://brpeças.pt");
  const whatsappMessage = encodeURIComponent("Confere o site da BR Peças Auto: ");
    ...
    <main className="min-h-screen bg-white text-zinc-900">
      ...
      <header className="sticky top-0 z-50 border-b border-zinc-200 bg-white">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          {/* Botão do Menu Hambúrguer (Telemóvel) */}
          ...
          <div className="flex md:hidden">
            ...
            <button
              ...
              className="rounded-lg bg-zinc-100 p-2 text-zinc-800 transition hover:bg-zinc-200"
        ...
        {isMobileMenuOpen && (
          ...
          <div className="absolute top-full left-0 w-full border-b border-zinc-200 bg-white px-6 py-6 shadow-xl md:hidden flex flex-col gap-4">
            ...
            <a
              ...
              className="text-lg font-semibold text-zinc-800 border-b border-zinc-100 pb-3"
            ...
            <a
              ...
              className="text-lg font-semibold text-zinc-800 pb-2"
            ...
            <a
              ...
              className="mt-2 rounded-lg bg-black px-5 py-3 text-center text-base font-semibold text-white"
      ...
      <section id="pecas" className="bg-zinc-50 py-20">

        <div className="mx-auto max-w-7xl px-6">

          <div id="resultados-pecas" className="mb-10 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-5 flex items-center justify-between border-t border-zinc-100 pt-4">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs font-medium text-zinc-500">+ IVA</span>
...
{/* FOOTER */}
      <footer id="contactos" className="border-t border-zinc-200 bg-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 space-y-2 text-sm text-zinc-500">
              <a href="#pecas" className="block hover:text-red-600">Peças</a>
              <a href="#salvados" className="block hover:text-red-600">Viaturas</a>
              <a href="/sobre" className="block hover:text-red-600">Sobre</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 space-y-3 text-sm text-zinc-500">
              ...
              <p>
                ...
                >
                  📍 Rua Prof. Lídio Correia Bloco Sul 684 Picoto, 3720-798, Vila de Cucujães, Portugal
                </a>
              </p>
              <p>📄 NIF: 225616785</p>
        ...
        {/* REDES SOCIAIS E PARTILHA */}
        <div className="border-t border-zinc-100 bg-neutral-950 py-8 px-6 text-white text-center">
          <div className="max-w-4xl mx-auto flex flex-col items-center gap-4">
            <p className="text-neutral-300 font-medium text-base">
              Gostou do site? Siga-nos nas redes sociais ou partilhe!
            </p>

            <div className="flex flex-wrap justify-center gap-3">
              {/* WhatsApp Partilha */}
              <a
                href={`https://api.whatsapp.com/send?text=${whatsappMessage}${currentUrl}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 bg-emerald-700 hover:bg-emerald-600 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors shadow-md"
              >
                <span>💬</span> WhatsApp
              </a>
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/brpecasauto?igsi=czRrMnU3ZWc3M3Jq&utm_source=qr"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-neutral-950 px-4 py-2 rounded-full text-sm font-bold transition-colors shadow-md"
              >
                <span>📷</span> Instagram
              </a>
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/share/19NzTiqsUY/?mibextid=wwXIfr"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors shadow-md"
              >
                <span>👥</span> Facebook
              </a>
              ...
              <button
                ...
                className="flex items-center gap-2 bg-neutral-900 hover:bg-neutral-800 text-white border border-neutral-700 px-4 py-2 rounded-full text-sm font-medium transition-colors shadow-md cursor-pointer"
              >
