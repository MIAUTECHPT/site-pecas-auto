...
export default function PecasPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-100 px-6 py-10 flex flex-col justify-between">
                        ...
                        <div className="mt-6 flex items-center justify-between border-t border-zinc-100 pt-5">
                          ...
                          <a
                            href={`https://wa.me/351916055975?text=${encodeURIComponent(
                              `Olá! Estou interessado na peça "${peca.name}" com a referência ${peca.reference}. Podem dar-me mais informações?`
                            )}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="rounded-xl bg-green-600 px-4 py-2 text-sm font-bold text-white transition hover:bg-green-700 flex items-center gap-1.5"
                          >
                            <span>💬</span> WhatsApp
                          </a>
                        </div>
      ...
      {/* RODAPÉ COM MORADA COMPLETA */}
      <footer className="mt-20 border-t border-zinc-200 bg-white py-12">
        <div className="mx-auto grid max-w-6xl gap-10 px-6 md:grid-cols-2">
          <div>
            <h3 className="font-bold text-black text-lg">BRPEÇAS</h3>
            <p className="mt-3 max-w-md text-sm text-zinc-500">
              Venda de peças auto e viaturas salvadas. Encontre componentes testados para o seu veículo de forma simples e rápida.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-black text-lg">Contactos & Morada</h3>
            <div className="mt-4 space-y-2 text-sm text-zinc-600">
              <p>📞 <strong>Telemóvel:</strong> 916 055 975</p>
              <p>✉️ <strong>Email:</strong> brpecasauto2022@gmail.com</p>
              <p>📍 <strong>Morada:</strong> Rua Principal, nº 123, Vila de Cucujães, Portugal</p>
            </div>
          </div>
        </div>
      </footer>
